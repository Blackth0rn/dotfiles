...
# set the BASH_ENV so that non-interactive shells still have access to the
# aliases set up in the ~/.bash_aliases file
...
if [ -f /home/greg/hub.bash_completion.sh ];
then
	. /home/greg/hub.bash_completion.sh
fi
